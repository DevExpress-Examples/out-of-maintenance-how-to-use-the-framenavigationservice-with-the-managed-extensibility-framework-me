...
Namespace MeffedNavigationService.MEF
	Public Class MeffedViewLocator
		...
		Private Function CreateFallbackView(ByVal documentType As String) As Object
			Dim cp = New ContentPresenter() With {.Content = New TextBlock() With {.Text = String.Format("""{0}"" type not found.", documentType), .FontSize = 25, .Foreground = New System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Red), .HorizontalAlignment = HorizontalAlignment.Center, .VerticalAlignment = VerticalAlignment.Center}}
