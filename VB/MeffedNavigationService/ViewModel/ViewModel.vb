...
Namespace MeffedNavigationService.ViewModel
	Public Class ViewModel
		...
		Private Sub NavigatedFrom(ByVal e As NavigationEventArgs) Implements INavigationAware.NavigatedFrom
			OnNavigatedFrom(e)
		End Sub
		Private Sub NavigatedTo(ByVal e As NavigationEventArgs) Implements INavigationAware.NavigatedTo
			OnNavigatedTo(e)
		End Sub
		Private Sub NavigatingFrom(ByVal e As NavigatingEventArgs) Implements INavigationAware.NavigatingFrom
			OnNavigatingFrom(e)
		End Sub
		#End Region
	End Class
